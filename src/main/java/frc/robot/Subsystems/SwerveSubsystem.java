...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem(File directory) {
    ...
    double angleConversionFactor =
        SwerveMath.calculateDegreesPerSteeringRotation(21.4285714286, 360);
    ...
    try {
      swerveDrive = new SwerveParser(directory).createSwerveDrive(Constants.Drivebase.maxSpeed);
  ...
  public SwerveSubsystem(
    ...
    swerveDrive = new SwerveDrive(driveCfg, controllerCfg, Constants.Drivebase.maxSpeed);
  }
