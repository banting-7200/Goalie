...
public class LimelightCommands {
  //Creates a instance of the LimelightDevice class, instance ensures only 1 instance of limelightdevice is created
  ...
  public void moveToAprilTagOffset(double distanceFromTag, double positionOffset) {
    ...
    // Offset is linked to robot position, ex.. -1 would be left of tag while 1 would be right of the tag
